...
% 1i=i=imagenary part.小波提取10hz信号。
...
for triali=1:nTrials
    ...
    % fft lengths of both signal, wavelet and data, are equal = n_conv
    % why this: sqrt(5/(2*pi*10)???
    % ifft doesn't change the length, though it can.
    convolution_result_fft = ifft(waveletfft.*fft(data(triali,:),n_conv)) * sqrt(5/(2*pi*10));
    % truncate begining and end of convolution.
