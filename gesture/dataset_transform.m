...
%%
folder_name = '/Volumes/Samsung_T5/data/BCI_competition/BCICIV_2a_gdf';
dataset_folder_name = '/Volumes/Samsung_T5/data/BCI_competition/BCICIV_2a_gdf/Train';
mkdir ([dataset_folder_name]);

%%
for i = 1:9
    filename=strcat(folder_name,'/A0',num2str(i),'T.gdf');
