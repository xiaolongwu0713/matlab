M=importdata([scriptdirectory,'FreeSurferColorLUT_V1.txt']);%Color Look Up Table, contains RGB + region name
...
%%
save([subject_directory,'/Electrodes/AsegWM.mat'],'AsegWM') %[R G B 'region name']
