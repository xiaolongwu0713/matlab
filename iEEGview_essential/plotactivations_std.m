...
% opengl neverselect
%Projecting the electrodes. Do nothing if all electrodes are seeg electrodes.
handles.pathToStdDir=[handles.ConfigurationPath.iEEGview_directory,'StdbrainModel'];
...
%% Display options
if isfield(handles,'viewstruct')
    viewstruct=handles.viewstruct;
else
...
plotactivations_L(cortex, vcontribs_norm, tala, ix, cmapstruct, viewstruct);
