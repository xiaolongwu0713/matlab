...
[window, windowRect] = PsychImaging('OpenWindow', screenNumber, black, [100,100,500,600]);
...
while ~KbCheck
    ...
    centeredRect1 = CenterRectOnPointd(baseRect, xCenter-300, yCenter-300);
    ...
    Screen('FillRect', window, red, centeredRect1);
