%% Versioin 3: This version has not been used, because patients face difficulty during the experiment
...
[w, rect] = Screen('OpenWindow', whichScreen, black); %,[100,100,900,900]) ;
