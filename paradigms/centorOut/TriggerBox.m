...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        ...
        function obj = TriggerBox(port, tcpPort)
            if nargin < 1
                port = [];
            end
            if nargin < 2
                ...
                obj.tcpOutput = tcpip('localhost', tcpPort, 'NetworkRole', 'client');
                fopen(obj.tcpOutput);
            end
            IOPort('CloseAll');
            if isempty(port)
        ...
        function OutputEventData(obj, eventData)
            ...
            if ~isempty(obj.tcpOutput)
                fwrite(obj.tcpOutput, resp, 'uint8');
            end
        end
